...
class AtariConfig(BaseConfig):
    ...
    def get_uniform_network(self, pretrain):
        ...
        if pretrain:
            ...
            pretrained_projection_state_dict = torch.load("/home/stud/xhan/BA/ficc/save/ficc_breakout/proj.pkl")
            efficientzero_net.lag.load_state_dict(pretrained_projection_state_dict, strict=False)
            
            pretrained_projection_head_state_dict = torch.load("/home/stud/xhan/BA/ficc/save/ficc_breakout/proj_h.pkl")
            efficientzero_net.lag.load_state_dict(pretrained_projection_head_state_dict, strict=False)
